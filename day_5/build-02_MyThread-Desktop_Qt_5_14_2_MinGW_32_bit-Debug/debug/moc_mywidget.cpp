...
#include <memory>
#include "../../02_MyThread/mywidget.h"
...
QT_MOC_LITERAL(1, 9, 7), // "myStart"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 22), // "on_buttonStart_clicked"
QT_MOC_LITERAL(4, 41, 21) // "on_buttonStop_clicked"

    },
    "MyWidget\0myStart\0\0on_buttonStart_clicked\0"
...
void MyWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyWidget::myStart)) {
                *result = 0;
                return;
            }
        }
